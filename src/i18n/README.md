...
├── client-template.json          # Template file for clients to edit
├── locales/
│   ├── en/
...
Clients can edit this file and send it back. The backend API should accept this JSON and store it per user.
...
The `client-template.json` file includes:
